...
describe('urlParser library', function () {
    ...
    describe('recursive url link search function', function () {
        before(function () {
            ...
            var mock_request_8 = post(urlEqualTo("/login"), {
        ...
        it('should find the right match for /5/:test/delete in stubs and receive url of /5/4536354345/delete', function () {
            assert.deepEqual(urlParser.hasMatchingStub(urlParser.buildUrlStorageLinkedList("/5/4536354345/delete")[0], test_stubs) != null, true);
        });
        it('should find the right match for /account/:varying_var/delete/ in stubs and receive url of /account/4536354345/delete', function () {
            assert.deepEqual(urlParser.hasMatchingStub(urlParser.buildUrlStorageLinkedList("/account/4536354345/delete")[0], test_stubs) != null, true);
        });
        it('should find the right match for /:varying_var/delete/ in stubs and receive url of /account/4536354345/delete', function () {
            assert.deepEqual(urlParser.hasMatchingStub(urlParser.buildUrlStorageLinkedList("/4536354345/delete")[0], test_stubs) != null, true);
        });
        ...
        it('should find the right match for /delete/:wtv/hello?meansit=:var in stubs and receive url of /delete/1/hello?meansit=7', function () {
            assert.deepEqual(urlParser.hasMatchingStub(urlParser.buildUrlStorageLinkedList("/delete/1/hello?meansit=7")[0], test_stubs) != null, true);
        });
        it('should find the right match for post request /login in stubs', function () {
            assert.deepEqual(urlParser.hasMatchingStub(urlParser.buildUrlStorageLinkedList("/login"), test_post_stubs)[0] != null, true);
        });
    });
