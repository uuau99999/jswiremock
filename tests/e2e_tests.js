...
(jswiremocklib = require('../jswiremock')),
	...
	(clearStubs = jswiremocklib.clearStubs),
	(suppressConsole = jswiremocklib.suppressConsole),
	(get = jswiremocklib.get),
	(post = jswiremocklib.post),
	(put = jswiremocklib.put),
	(patch = jswiremocklib.patch),
	(_delete = jswiremocklib.delete),
	(options = jswiremocklib.options),
	(urlEqualTo = jswiremocklib.urlEqualTo),
	(a_response = jswiremocklib.a_response),
	(stopJSWireMock = jswiremocklib.stopJSWireMock);

var jswiremock = new jswiremock(5001); //port

stubFor(
	jswiremock,
	get(urlEqualTo('/account/:varying_var/create/')).willReturn(
		a_response()
			.withStatus(200)
			.withHeader({
...
stubFor(
	jswiremock,
	get(
		urlEqualTo('/account/:varying_var/delete/'),
		{},
		{
